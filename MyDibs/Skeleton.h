...
{
public:
	Skeleton(ColliderMap* colmap, RandomMap* randomMap, Player* player);
	Skeleton(ColliderMap* colmap, RandomMap* randomMap, Player* player, TileIndex index);
	virtual ~Skeleton();
...
private:
	...
	// MyAnimationRenderer* mBlackRenderer;
