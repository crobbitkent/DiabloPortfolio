...
class Fallen : public Monster
{
public:
	Fallen(ColliderMap* colmap, RandomMap* randomMap, Player* player);
	Fallen(ColliderMap* colmap, RandomMap* randomMap, Player* player, TileIndex index);
	virtual ~Fallen();
